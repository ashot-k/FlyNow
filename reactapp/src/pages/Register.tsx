    ...
    return (
        <form onSubmit={handleRegistration} className={className}>
            ...
            <div
                ...
                <div className={"flex w-full flex-col items-center gap-1.5 sm:w-4/12"}>
                    ...
                    <div className={"flex w-full flex-col gap-1.5"}>
                        ...
                        <Input
                            name={"username"}
                            className={
                                "w-full rounded-lg bg-transparent px-3 py-2 text-white outline outline-1 outline-gray-500 invalid:visible data-[focus]:outline-flyNow-light sm:py-1.5"
                            }
                            type={"text"}
                ...
                <div className={"flex w-full flex-col items-center gap-1.5 sm:w-6/12"}>
                    ...
                    <div className={"flex w-full gap-3.5"}>
                        ...
                        <div className={"flex w-1/2 flex-col gap-1.5"}>
                            <label className={"w-full"} htmlFor={"postalCode"}>
                                Zip Code
                            </label>
                            <Input
                                name={"postalCode"}
            ...
            <div className={"flex w-full flex-col items-center gap-2"}>
                ...
                <div
                    className={
                        "text-lg data-[alert-type=danger]:text-red-500 data-[alert-type=success]:text-emerald-500"
                    }
