...
export const FlightList = ({flightList, departureDate, returnDate, dictionaries, destination, origin}: any) => {
    ...
    return (
        <div className={"flight-list w-100 d-flex flex-column flex-wrap gap-4 justify-content-start align-items-center"}>
            <hr/>
            <div className={"search-info d-flex flex-column justify-content-center align-items-center p-2 w-100"}>
